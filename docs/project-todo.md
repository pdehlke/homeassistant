...
2. Fix nabucasa fragility: `hass_nabucasa`'s remote-UI/ACME certificate handler
...
5. ~~Tesla inverter integration~~ Cancelled 2026-08-09: not happening. The two
...
11. ~~Decide whether to add a periodic `homeassistant.reload_config_entry`
